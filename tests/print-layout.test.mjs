...
test('4x6 sheet packs six US passport photos',()=>{const s=passportSize('us',300),p=packRects(PAPER.photo4x6.width,PAPER.photo4x6.height,s.widthPt,s.heightPt,{margin:8,gap:4});assert.equal(p.count,6)});
