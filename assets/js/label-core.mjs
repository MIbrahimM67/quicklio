...
export const LABEL_PRESETS={
  avery5160:{label:"Avery 5160 · 30-up",paper:"letter",cols:3,rows:10,labelW:inToPt(2.625),labelH:inToPt(1),marginX:inToPt(.1875),marginY:inToPt(.5),gapX:0,gapY:0},
  ...
  a4_21:{label:"A4 · 21 labels",paper:"a4",cols:3,rows:7,labelW:mmToPt(63.5),labelH:mmToPt(38.1),marginX:mmToPt(7.25),marginY:mmToPt(15.15),gapX:0,gapY:0},
