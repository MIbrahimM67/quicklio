...
The Halloween candy calculator can optionally store one prior turnout count in browser local storage. The pumpkin stencil maker processes images locally in the browser, and the Christmas lights calculator is arithmetic-only. No account or server database is used.
